---
layout: post
title: "iOS Mobile Application Development using Swift"
subtitle: "Developed an application for Ontario Public Service"
background: '/img/posts/Explore-Ontario/Background.jpg'
---

# Section 1

[<img src="\img\posts\Explore-Ontario\Intro.png">](https://youtu.be/9D7S-SC50J8)
Click above to view the Demo Video

## Role

**Project Team Leader**: Acted as a representative among the seven programmers. Contributed to the project's success by overseeing team coordination, task delegation, and project timeline management.

**Partner Liaison**: Acted as the primary point of contact for partners by facilitating communication, gathering requirements, and addressing concerns.

**Back-End Developer**: Implemented essential features such as speech recognition and location tracking.

## My Contribution

Implemented *Speech Recognition feature*: Utilized Apple Speech Framework to implement a robust speech recognition feature.

Implemented *GPS and location tracking system*: Utilized Apple Core Location Framework to effectively track the user's current location and position landmarks around the user.

## Technical Tools utilized

Swift, Xcode

Apple Speech, Combine, Core Location Framework
...
GitHub link with source codes is not available due to the request of the client.
